...
// Module: HelpersLib.Real.Order
// Imports: Init Mathlib.Data.Real.Basic Mathlib.Data.Real.Sqrt
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_HelpersLib_Real_Order(uint8_t builtin, lean_object* w) {
lean_object * res;
