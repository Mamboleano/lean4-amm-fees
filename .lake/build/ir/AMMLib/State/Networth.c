...
// Module: AMMLib.State.Networth
// Imports: Init AMMLib.State.MintedWall AMMLib.State.AtomicWall AMMLib.State.State
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_AMMLib_State_Networth(uint8_t builtin, lean_object* w) {
lean_object * res;
