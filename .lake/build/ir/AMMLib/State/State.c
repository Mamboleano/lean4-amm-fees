...
// Module: AMMLib.State.State
// Imports: Init AMMLib.State.Tokens AMMLib.State.AMMs AMMLib.State.AtomicWallSet AMMLib.State.MintedWallSet
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_AMMLib_State_State(uint8_t builtin, lean_object* w) {
lean_object * res;
