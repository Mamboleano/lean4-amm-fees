...
// Module: AMMLib.State.Supply
// Imports: Init HelpersLib.Finsupp2 AMMLib.State.Tokens AMMLib.State.AMMs AMMLib.State.State
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_AMMLib_State_Supply(uint8_t builtin, lean_object* w) {
lean_object * res;
